export default function Footer() {
  ...
  return (
    <footer style={styles.footer} className="d-flex flex-column align-items-center">
      <img style={styles.panda} src="../public/images/pandapop-icon.jpg" alt="" />
      <ul style={styles.ul} className="nav d-flex justify-content-between">
       <a href="www.linkedin.com/in/amanda-andrews-4baa72290"><li className="bi bi-linkedin icon"></li></a> 
